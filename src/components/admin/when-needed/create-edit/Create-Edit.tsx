...
import { createWhenNeeded } from "@/actions/when-needed/create";
import { editWhenNeeded } from "@/actions/when-needed/edit";

export default function CreateEditWhenNeededForm({
  header,
  text,
  id,
  order,
  ...
  const usedAction = isEdit ? editWhenNeeded : createWhenNeeded;
